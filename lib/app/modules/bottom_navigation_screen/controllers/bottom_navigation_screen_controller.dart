...
import 'package:kamariati_cosmetic_project/app/modules/category_screen/views/store_screen_view.dart';
...
class BottomNavigationScreenController extends GetxController {
  ...
  final screens = [HomeScreenView(), StoreScreenView(), CartScreenView(), ProfileScreenView()];
}
